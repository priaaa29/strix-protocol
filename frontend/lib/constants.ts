...
export const CONTRACT_IDS = {
  ...
  oracle: process.env.NEXT_PUBLIC_ORACLE_ID || 'CCQNF6FO7WXRXDRMQHBX5YIMJQUPEWBM6BBO76M5WQVNV4IN5PJMQF7',
} as const;
...
export const REFLECTOR_ORACLE_TESTNET = 'CCQNF6FO7WXRXDRMQHBX5YIMJQUPEWBM6BBO76M5WQVNV4IN5PJMQF7';
