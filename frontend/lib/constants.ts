...
export const CONTRACT_IDS = {
  ...
  usdcToken: process.env.NEXT_PUBLIC_USDC_TOKEN_ID || 'CBA4XQJCNN76UX3AQ63EKQXQMMIHTVENTXV2QNXLCOPMYIXAESQZUDZQ',
  oracle: process.env.NEXT_PUBLIC_ORACLE_ID || 'CCYOZJCOPG34LLQQ7N24YXBM7LL62R7ONMZ3G6WZAAYPB5OYKOMJRN63',
} as const;
...
// Reflector oracle contract (testnet)
export const REFLECTOR_ORACLE_TESTNET = 'CCYOZJCOPG34LLQQ7N24YXBM7LL62R7ONMZ3G6WZAAYPB5OYKOMJRN63';
